...
Original file is located at
    https://colab.research.google.com/drive/1nTMQFfber0vyPDE4yus6hMr2MFJAX1nH
"""
...
# model.add(input_shape=(img_width, img_height,3))
# model.add(Flatten())
model.add(Reshape((30000,1),input_shape=(100,100,3)))
model.add(Flatten())
...
model.save_weights('2D1000.h5')
model.save('2D1000l.h5')
